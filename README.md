...
PodHopper is a podcast player for Android phones and Android Automotive OS,
focused on keeping your playback position in perfect sync between devices.
Start an episode on your phone, hop in the car, and pick up exactly where you
left off, and vice versa.

PodHopper is a fork of [AntennaPod](https://antennapod.org), the open-source
podcast manager. Enormous credit goes to the AntennaPod contributors, whose
work forms the foundation of this app. In accordance with the GPL-3.0 license,
the complete source code of PodHopper is available in this repository.

PodHopper is developed by Cover Two Strategies LLC and is not affiliated with
or endorsed by the AntennaPod project.
