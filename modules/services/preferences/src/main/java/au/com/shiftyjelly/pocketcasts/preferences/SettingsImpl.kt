...
class SettingsImpl @Inject constructor(
    ...
    override val podcastRefreshFrequency = UserSetting.PrefFromInt(
        ...
        sharedPrefs = sharedPreferences,
        fromInt = { PodcastRefreshFrequency.fromIndex(it) ?: PodcastRefreshFrequency.default },
        toInt = { it.index },
    )
    ...
    override val podhopperEmail = UserSetting.StringPref(
        sharedPrefKey = "podhopperEmail",
        defaultValue = "",
        sharedPrefs = sharedPreferences,
    )

    override val podhopperRefreshToken = UserSetting.StringPref(
        sharedPrefKey = "podhopperRefreshToken",
        defaultValue = "",
        sharedPrefs = sharedPreferences,
    )
