...
public class Media3PlaybackService extends MediaLibraryService {
        ...
        public void onIsPlayingChanged(boolean isPlaying) {
            ...
            if (PlaybackService.isRunning) {
                ...
                if (currentPlayable != null) {
                    ...
                    if (PodHopperPositionSync.getInstance() != null) {
                        PodHopperPositionSync.getInstance().pushPosition(currentPlayable, true);
                    }
                }
            }
    ...
    public void onDestroy() {
        ...
        saveCurrentPosition();
        if (PodHopperPositionSync.getInstance() != null && currentPlayable != null) {
            PodHopperPositionSync.getInstance().pushPosition(currentPlayable, true);
        }
                        ...
                        ignored -> {
                            ...
                            if (duration > 0) {
                                ...
                                if (currentTime - lastPositionSaveTime >= POSITION_SAVE_INTERVAL_MS) {
                                    saveCurrentPosition();
                                    if (PodHopperPositionSync.getInstance() != null) {
                                        PodHopperPositionSync.getInstance().pushPosition(currentPlayable, false);
                                    }
